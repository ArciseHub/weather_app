...
class CustomColors {
  ...
  Color todayForecastHighlightedColorOne = const Color(0xff4EBFFD);
  Color todayForecastHighlightedColorTwo = const Color(0xff327CEF);
  Color updatingColor = const Color.fromARGB(255, 221, 211, 13);
}
